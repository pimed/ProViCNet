...
class UCTransNet(nn.Module):
    def __init__(self, config,n_channels=3, n_classes=1,img_size=224,vis=False, ContrastiveLearningMode=False):
        super().__init__()
        self.vis = vis
        ...
        # For DINO feature extraction
        self.ContrastiveLearningMode=ContrastiveLearningMode
    ...
    def forward(self, x):
        ...
        if self.ContrastiveLearningMode == True:
